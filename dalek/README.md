...
A digital design package for a bronze Dalek robot under three feet tall, with a circular reinforced base, a one-piece skirt with twelve flat panels, a combined shoulder and neck, and concealed arm servos. FACET-1 has ten STL designs and fourteen printed pieces with the four motor clamps. The motor cable-tie option omits those clamps and needs ten printed pieces. Four Adafruit 3777 TT motors and 3766 wheels drive the base; a fifth motor and wheel turn the head through an adjustable friction drive. The original rear TTGO T-Display ESP32, circular arm motion, Wi-Fi network/access-point controls and 24 original MP3 voices remain.
...
The shared pitch carrier is printed twice and the optional hook clamp four times. Four body pieces stack vertically: base, 213 mm faceted skirt, 186 mm combined shoulder/neck, and head. The skirt's twelve flat faces taper in a straight line from 300 mm to 220 mm across opposite vertices over 210 mm, followed by its 3 mm register. The round base and round joint collars remain. Four rows of domed details sit normal to the flat panels; there is no exterior middle band or paint-color break. Both taller body prints stay below the 320 mm maximum-minus-5 mm height target. Overall height remains 563.8 mm. The base stays 300 mm in diameter with a 6 mm floor; its 8 mm brim allowance needs 316 x 316 mm in the H2D single-nozzle area. Four printed motor clamps use four screws total, or two ties retain each motor. The 216 mm board platform is one print with four legs. Fit the battery and populated platform before lowering the complete skirt around them. Assemble the upper mechanisms through the open bottom before seating the upper shell.

The faceted skirt slice uses 1009.47 g of PLA and predicts 23 hours 55 minutes 37 seconds; have at least 1.12 kg available with reserve. The unchanged upper shell uses 1235.49 g of PETG; allow at least 1.36 kg. Each job exceeds one 1 kg spool. The complete clamp-option package predicts 4180.82 g of filament, 2473.98 g of installed printed plastic and 124.28 hours of sequential printing. These are slicer estimates.

The [mesh validation](cad/validation.json), [H2D slice record](cad/h2d-slice-check.json) and [verification notes](docs/verification.md) record dimensions, hashes, settings and digital checks. Match each report to the released FACET-1 meshes. Removing a joint does not establish a physical strength rating; base strength, completed mass, friction adjustment and loaded driving require the tests in the manual. Current prices and allowances are in the BOM files.
