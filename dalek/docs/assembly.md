...
Read the whole manual and open the CAD preview. Inventory `bom/electronics.csv`, `bom/hardware.csv`, and `bom/printed-parts.csv`. MOUNT-1 has ten STL designs. Print the shared pitch carrier twice and the optional motor clamp four times, giving fourteen printed pieces. The motor-tie option omits all four clamps and needs ten prints. The skirt is one 213 mm print; the shoulder and neck are one 186 mm print. Select one battery and its matching charger. Keep purchased screws, bearings, retainers and spacers in labelled bags.
...
The skirt slice uses1040.72g of PLA including supports and brim; allow at least1.15kg with reserve. The combined upper shell uses1235.49g of PETG; allow at least1.36kg. Neither job fits on one1kg spool. Arrange compatible filament changes or sufficient spool capacity. The BOM's3kg PLA and3kg PETG supply allowances cover the recorded jobs and reserve; they are not predicted consumption. Match each printer job to its released mesh hash.
