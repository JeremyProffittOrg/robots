...
This is a first-prototype design. No physical strength, payload, traction, runtime, bearing fit or finished robot operation has been measured. Match each generated validation and H2D report to the released MOUNT-1 mesh hashes. Complete the physical assembly, load and motion gates before operation.
...
2. `02_skirt.stl`: PLA, large opening down. Four walls and 15 percent infill. The first 110 mm tapers from diameter 300 to 250; the next 100 mm tapers to 220. Its 3 mm top register makes a 213 mm print. The four bump rows and integral middle rib are retained. The bottom opening is 264 mm, the middle rib bore 240 mm and the main top opening 184 mm. The upper-joint nut bosses project locally into that top opening, so do not use its nominal diameter alone to plan an insertion. Lift the whole skirt for battery/platform service. There is no bolted middle joint.
...
Identifiers 03 and 05 are retired. The four stacked body pieces are base, skirt, combined upper shell and head. Use the current printed-parts manifest for all quantities and dimensions. Paint external surfaces only. Keep bearing seats, registers, sliding faces, horn seats, tie passages and the friction track clean. Use bronze panels, silver stems and near-black bumper, liner, roots and cup.

The current skirt slice uses1040.72g of PLA including supports and brim, with a predicted24 hours8 minutes10 seconds. Allow at least1.15kg including a10percent reserve. The combined upper shell uses1235.49g of PETG and predicts39 hours10 minutes11 seconds; allow at least1.36kg including reserve. Neither job fits on one1kg spool. Arrange compatible filament changes or sufficient spool capacity before starting. The full clamp-option package predicts4212.07g of filament,2469.59g of installed printed plastic and124.49hours of sequential printing. These are slicer estimates, not measured consumption or finished robot mass. Filament purchase allowances include reserve; match every actual job to the released mesh hash.
...
- Skirt origin: Z67.8; slope transition Z177.8; body top Z277.8; register top Z280.8.
