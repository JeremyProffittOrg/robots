...
The ROUND-10 design has a circular 300 mm base and remains below 914.4 mm, or three feet. Six complete body sections stack vertically: base, lower skirt, upper skirt, shoulder, neck and head. Raised hemispheres and their rings, shoulder slats, neck grille, rear-board retention, dome details and actuator mounts are integrated into those prints. A common concealed pitch carrier, two decorative arms and a sliding head-motor carriage complete the ten-STL set. The carrier is printed twice. The separate appearance chapter and 100-image source inventory document the reference details. The circular base is a requested customization; photographed bronze television props usually have faceted fenders.
