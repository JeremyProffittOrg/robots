...
detail and no more than199 purchased physical pieces, counting every fastener.
...
Run from `C:/dev/robots/fable-r2d3`, using the installed OpenSCAD, Bambu Studio,
