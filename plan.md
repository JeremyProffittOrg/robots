...
- [~] Publication/email, /root plus delegated email agent: final artifactsready for GitHub Actions/OIDC S3 upload, object/link verification andHTML email withPDF. Done when workflow conclusion is success, downloaded object SHA256 matches local MP4, and actual SES MessageId is returned and recorded.
