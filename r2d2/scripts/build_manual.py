...
def main():
 ...
 for path in ['docs/mechanical.md','docs/electrical.md','docs/assembly.md','audio/README.md','docs/verification.md']:
  ...
  if path=='docs/mechanical.md':
   for file,title,caption in [('section.png','Internal frame and bearing stack','Section of the CAD: battery low in the body, rear steering under the frame, and a separate head bearing above the electronics.'),('exploded.png','Assembly groups','Groups are separated vertically for visibility. Use the height stack for actual positions.'),('rear.png','Rear foot and service access','The rear foot stays open for gear and harness service. The switch faceplate is fitted to the chosen removable upper shell quarter during assembly.')]:
